...
list<-list.files()
for(i in list){
   setwd(paste0("/bulk/zhenbin/Sorghum_diversity/GWAS/old/",i))
   ...
   png(paste0("/bulk/zhenbin/Sorghum_diversity/GWAS/Figures/",i,".png"),width=12,height=6,type="cairo",res=600,units="in")
